...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
    	...
    	<script src="<?php echo base_url(); ?>system/application/js/mootools.js"></script>
		<script src="<?php echo base_url(); ?>system/application/js/mootools-more.js"></script>
		<script src="<?php echo base_url(); ?>system/application/js/configurator.js"></script>
        <script>
